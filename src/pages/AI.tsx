...
const AI = () => {
  ...
  return (
    <main className="p-6">
      ...
      {/* Ask Section */}
      <div className="rounded-2xl bg-card shadow-card mb-10 border-t-4 border-t-slack">
        <div className="p-6 space-y-5">
          <div className="flex items-center gap-2.5 mb-1">
            <ColoredIcon icon={Sparkles} bgClass="bg-slack/10" iconClass="text-slack" size="sm" />
            <div>
      ...
      {/* Latest AI Response (chat bubble) */}
      {latestAnswer && (
        <div className="mb-10 flex items-start gap-2.5">
          ...
          <div className="max-w-[680px] rounded-2xl rounded-tl-sm bg-slack/[0.06] px-4 py-3 prose prose-sm max-w-none text-foreground/90">
      ...
      {/* Query History */}
      <h2 className="mb-5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Query History</h2>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 rounded-2xl bg-card shadow-card">
        ...
        <div className="space-y-6">
          {queries.map((q) => (
            <div key={q.id} className="space-y-2">
              ...
              {/* Answer — left aligned bubble with AI avatar */}
              {q.answer && (
